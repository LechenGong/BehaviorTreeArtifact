...
void ExecutionBullfangoStay::ParseDataFromXml( [[maybe_unused]] XmlElement* xmlElement )
{
}

void ExecutionBullfangoStay::ExportAttributeToXml( [[maybe_unused]] XmlElement* xmlElement )
{
}
